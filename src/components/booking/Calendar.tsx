    ...
    <div style={{
      ...
      <DayPicker
        ...
        classNames={{
          ...
          month_caption: 'text-left font-medium text-lg text-[#374151] pl-2',
          nav: 'flex gap-0 absolute right-0 top-0',
