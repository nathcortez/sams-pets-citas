  ...
  return (
    <div style={{
      ...
      <DayPicker
        ...
        classNames={{
          root: 'w-full',
          caption: 'flex justify-between items-center w-full mb-5',
          month_caption: 'font-medium text-lg text-[#374151]',
          nav: 'flex gap-1',
          ...
          weekday: 'w-[14.28%] text-center text-[#9CA3AF] font-medium text-xs uppercase tracking-wider',
          weeks: 'flex flex-col w-full',
          week: 'flex w-full gap-1',
          day: 'w-[14.28%]',
          day_button: 'w-full h-[44px] flex items-center justify-center text-base font-normal text-[#374151] rounded-full transition-all duration-200 hover:bg-[#F3F4F6]',
